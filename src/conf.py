...
# (translatable)
TAGS_INDEX_PATH = {
    "en": INDEX_PATH + "/tags/index.html",
    "es": INDEX_PATH + "/etiquetas/index.html"
}
...
CATEGORIES_INDEX_PATH = {
    "en": INDEX_PATH + "/categories/index.html",
    "es": INDEX_PATH + "/categorias/index.html"
}
